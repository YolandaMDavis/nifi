...
class AuthorizationsRule extends GenericMigrationRule{
    ...
    Boolean supportedVersion(String versionStr) {
        ...
        Version supportedV110 = new Version("1.1.0",".")
        return Version.VERSION_COMPARATOR.compare(version,supportedV100) >= 0 && Version.VERSION_COMPARATOR.compare(version,supportedV110) < 0
    }
