...
class AuthorizationsRule extends GenericMigrationRule{
    ...
    Boolean supportedVersion(String versionStr) {
        ...
        Version supportedV130 = new Version("1.3.0",".")
        return Version.VERSION_COMPARATOR.compare(version,supportedV120) >= 0 && Version.VERSION_COMPARATOR.compare(version,supportedV130) <= 0
    }
